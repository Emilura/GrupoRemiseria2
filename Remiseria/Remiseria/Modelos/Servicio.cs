...
public int Id_Servicio { get => id_Servicio; set => id_Servicio = value; }
        ...
        public Servicio(int id_Cliente, int id_Vehiculo, int id_chofer, DateTime fecha, DateTime horaInicio, DateTime horaFin, string origen, string destino, float precio, string estado, bool activo)
        {
